...
* **POS Simulator Live Order Delivery Instructions & Placeholder Polish:** Enhanced the delivery instruction text input during live customer phone orders to accept natural phrasing variations (including phrases like "Call when you arrive at the gate", "Please have driver call", or any note instructing to call the customer). Restored high-contrast bold placeholder styling so guidance text remains sharp and visible across store Chromebooks and tablets, allowing trainees to advance either by pressing Enter and clicking the Pizzas tab or by clicking the Pizzas tab directly once their delivery note is typed.
